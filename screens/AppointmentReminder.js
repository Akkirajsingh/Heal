...
class AppointmentReminder extends Component {
    constructor(props) {
        ...
        this.state = {
            loadingMsg: 'Loading Medical Problems....', AccountId:'', todayDate: today, Remindervalue: '', userid: '', AccessToken: '', emailId: '', reminderType: 0, mobilenumber: '', reminderDate: '', contactNo: '', isLoading: false, selectedHours: 0, selectedMinutes: '', AppointRemindId: '', description: ''
        };
    }
    async componentDidMount() {
        ...
        APPOINTMENT_REMINDER_URL = APPOINTMENT_REMINDER;
        ...
        if (USER_DATA.hasOwnProperty('Hospital') && USER_DATA.Hospital.AppointmentLogin == false) {
            ...
            APPOINTMENT_REMINDER_URL = USER_DATA.ServiceURL + HOSP_APPOINTMENT_REMINDER;
        }
        ...
        this.setState({
            ...
            AppointRemindId: params.AppointRemindId,
        });
    }
    ...
    setReminder = () => {
        ...
        const ReminderService = {
            ...
            RemindMeIn: 3,
            ReminderFor: 'Appointment',
            ReminderId: 0,
            ReminderItemId: this.state.AppointRemindId,
            ReminderType: this.state.reminderType,
        };
        console.log('ReminderService', ReminderService);
        fetch(`${this.state.ServiceUrl}api/ReminderService/ReminderTransaction`, {
            method: 'POST',
            headers: {
